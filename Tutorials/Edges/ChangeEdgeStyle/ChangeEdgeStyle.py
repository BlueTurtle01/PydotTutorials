...
"""
Add the argument "style" and a float for the width you desire.
This only changes this edge's style, there is also a tutorial for changing the default values that affects
the style of all edges.
"""
graph.add_edge(pydot.Edge("Node 1", "Node 2", style="dashed"))
